...
import net.school.windows.v4.base.RoundWindow;
...
public class TestRoundWindow {
    ...
    public void testRoundWindow1() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(10, roundWindow.getCenter().getX()),
                () -> Assertions.assertEquals(20, roundWindow.getCenter().getY()),
    ...
    public void testSetRoundWindow() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(30, roundWindow.getCenter().getX()),
                () -> Assertions.assertEquals(40, roundWindow.getCenter().getY()),
    ...
    public void testMoveToRoundWindow1() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(100, roundWindow.getCenter().getX()),
                () -> Assertions.assertEquals(50, roundWindow.getCenter().getY()),
    ...
    public void testMoveRelRoundWindow() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(110, roundWindow.getCenter().getX()),
                () -> Assertions.assertEquals(70, roundWindow.getCenter().getY()),
                () -> assertEquals(10, roundWindow.getRadius())
        );
    }
    ...
    public void testResizeRoundWindow() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(10, roundWindow1.getCenter().getX()),
                () -> Assertions.assertEquals(20, roundWindow1.getCenter().getY()),
                () -> assertEquals(20, roundWindow1.getRadius())
        );
        RoundWindow roundWindow2 = new RoundButton(10, 20, 10, "OK");
        roundWindow2.resize(0.5);
        assertAll(
                () -> Assertions.assertEquals(10, roundWindow2.getCenter().getX()),
                () -> Assertions.assertEquals(20, roundWindow2.getCenter().getY()),
                () -> assertEquals(5, roundWindow2.getRadius())
        );
        RoundWindow roundWindow3 = new RoundButton(10, 20, 10, "OK");
        roundWindow3.resize(0.01);
        assertAll(
                () -> Assertions.assertEquals(10, roundWindow3.getCenter().getX()),
                () -> Assertions.assertEquals(20, roundWindow3.getCenter().getY()),
