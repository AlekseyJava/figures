...
public class TestListBox {
    ...
    public void testListBox1() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(10, listBox.getTopLeft().getX()),
                () -> Assertions.assertEquals(20, listBox.getTopLeft().getY()),
                () -> Assertions.assertEquals(30, listBox.getBottomRight().getX()),
                () -> Assertions.assertEquals(40, listBox.getBottomRight().getY()),
    ...
    public void testListBox3() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(10, listBox.getTopLeft().getX()),
                () -> Assertions.assertEquals(20, listBox.getTopLeft().getY()),
                () -> Assertions.assertEquals(39, listBox.getBottomRight().getX()),
                () -> Assertions.assertEquals(59, listBox.getBottomRight().getY()),
    ...
    public void testSetListBox() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(0, listBox.getTopLeft().getX()),
                () -> Assertions.assertEquals(0, listBox.getTopLeft().getY()),
                () -> Assertions.assertEquals(200, listBox.getBottomRight().getX()),
                () -> Assertions.assertEquals(100, listBox.getBottomRight().getY()),
    ...
    public void testMoveToListBox1() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(100, listBox.getTopLeft().getX()),
                () -> Assertions.assertEquals(50, listBox.getTopLeft().getY()),
                () -> Assertions.assertEquals(129, listBox.getBottomRight().getX()),
                () -> Assertions.assertEquals(89, listBox.getBottomRight().getY()),
                () -> assertEquals(30, listBox.getWidth()),
                () -> assertEquals(40, listBox.getHeight())
        );
    }
    ...
    public void testMoveRelListBox() throws WindowException {
        ...
        assertAll(
                () -> Assertions.assertEquals(110, listBox.getTopLeft().getX()),
                () -> Assertions.assertEquals(70, listBox.getTopLeft().getY()),
                () -> Assertions.assertEquals(139, listBox.getBottomRight().getX()),
                () -> Assertions.assertEquals(109, listBox.getBottomRight().getY()),
                () -> assertEquals(30, listBox.getWidth()),
                () -> assertEquals(40, listBox.getHeight())
        );
    }
    ...
    public void testResizeListBox() throws WindowException {
        ...
        listBox1.resize(2);
        assertAll(
                () -> Assertions.assertEquals(10, listBox1.getTopLeft().getX()),
                () -> Assertions.assertEquals(20, listBox1.getTopLeft().getY()),
                () -> Assertions.assertEquals(69, listBox1.getBottomRight().getX()),
                () -> Assertions.assertEquals(99, listBox1.getBottomRight().getY()),
        ...
        listBox2.resize(0.5);
        assertAll(
                () -> Assertions.assertEquals(10, listBox2.getTopLeft().getX()),
                () -> Assertions.assertEquals(20, listBox2.getTopLeft().getY()),
                () -> Assertions.assertEquals(24, listBox2.getBottomRight().getX()),
                () -> Assertions.assertEquals(39, listBox2.getBottomRight().getY()),
        ...
        listBox3.resize(0.5);
        assertAll(
                () -> Assertions.assertEquals(10, listBox3.getTopLeft().getX()),
                () -> Assertions.assertEquals(20, listBox3.getTopLeft().getY()),
                () -> Assertions.assertEquals(11, listBox3.getBottomRight().getX()),
                () -> Assertions.assertEquals(21, listBox3.getBottomRight().getY()),
        ...
        assertAll(
                () -> Assertions.assertEquals(10, listBox4.getTopLeft().getX()),
                () -> Assertions.assertEquals(20, listBox4.getTopLeft().getY()),
                () -> Assertions.assertEquals(10, listBox4.getBottomRight().getX()),
                () -> Assertions.assertEquals(20, listBox4.getBottomRight().getY()),
