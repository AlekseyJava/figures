...
import net.school.windows.v4.ComboBox;
import net.school.windows.v4.Desktop;
import net.school.windows.v4.ListBox;
import net.school.windows.v4.Point;
import net.school.windows.v4.RadioButton;
import net.school.windows.v4.RectButton;
